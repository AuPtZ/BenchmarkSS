...
**If the length of OGS is less than topN, please select the optimal SSMs and topN with the relative high scores between 10 and length of OGS. If the user want to select mutiple SSMs for SS_all, the performance score over the average score is highly recommended.**  
