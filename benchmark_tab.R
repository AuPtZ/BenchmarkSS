...
initial_bm <- tagList(
  h3("Welcome to Benchmark module!"),
  h4("To access demo files, please navigate to the data page."),
  h4("For demonstration results, please proceed to the job center page."),
  p("In this module, you can evaluate signature search (SS) methods based on signature and well-annotated drugs in L1000.",
    br(),
    "The Benchmark module requires the following settings:"),
  div(style = "text-align:center",
  img(src ="imgbm1.png",width = "700px"),
  ),
  br(),
  br(),
  p(strong('1. Select Drug profiles (L1000)'),
    br(),
    strong('2. Select SS methods to test (at least two)'),
    br(),
    strong('3. A signature (header with gene and logFC) to perform test'),
    br(),
    strong('4. Drug annotations which user can download blank annotaion table of drugs by click the download button')
    ),
  div(style = "text-align:center",
  img(src ="imgbm2.png",width = "400px"),
  ),
  br(),
  br(),
  p(
    strong("Notably, we provide two types of drug annotation methods (AUC and ES), and users must use at least one method to assess the performance of SS. It is impractical to annotate all drugs; however, the more annotations obtained, the more accurate the results will be."),
    br(),
    br(),
    strong('1. AUC'),br(),
  ...
  div(style = "text-align:center",
  img(src ="imgbm3.png",width = "350px"),
  ),
  br(),
  p(
    "We will then calculate the drug scores and rank them based on the confusion matrix using the Area Under Curve (",
    strong(" AUC "),
    "), the higher",
    strong(" AUC "),
    ...
    br(),
    strong('2. ES'),br(),
    "If you have annotations for effective L1000 drugs (generally based on Clinical info, such as FDA-approved drugs), you can upload them into step 4b. The file should appear as follows:",br(),
  ),
  div(style = "text-align:center",
  img(src ="imgbm4.png",width = "300px"),
  ),
  br(),
  br(),
  p(
    "We will then calculate the drug scores and perform drug set enrichment score (",
    strong("ES"),
    "), the lower",
    strong(" ES "),
    "indicates better performance.",br(),
    br(),
    "Finally, click the Run button, and you will obtain a job ID",
    strong("jobid"),
    " starting with \"",
    strong("BEN"),
    "\". It may take approximately 15 minutes to obtain the results, but you can close the page and input the job ID in the ",
    "job center",
    "for later result inquiry.",br(),
  ),
  div(style = "text-align:center",
  img(src ="imgbm5.png",width = "300px")
  ),
  br(),
  p(
